# Claude Instructions for Antigravity SaaS Boilerplate

## Project Context
You are working with a production-ready Next.js 15+ TypeScript SaaS boilerplate called Antigravity. This is a complete starter template for building SaaS applications with authentication, and modern web technologies.

## Architecture Overview

### Core Technologies
- **Frontend**: Next.js 15+ with App Router, React 19+, TypeScript 5.9+
- **Styling**: TailwindCSS 4.1+ with Shadcn UI component library
...
- Leverage Shadcn UI components: `btn`, `card`, `modal`, `dropdown`, etc.
...
Remember: This is a complete SaaS boilerplate that handles user data. Always prioritize security, proper error handling, and user experience in any modifications or additions. 