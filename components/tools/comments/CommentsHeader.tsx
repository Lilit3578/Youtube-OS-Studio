            ...
            {hasComments && (
                <Popover>
                    <PopoverTrigger asChild>
                        <Button className="bg-neutral-900 hover:bg-neutral-800 text-white rounded-md px-6 py-2 h-auto text-sm font-medium transition-colors">
                            DOWNLOAD
                        </Button>
                    </PopoverTrigger>
                    <PopoverContent
                    ...
                    >
                        <div className="flex flex-col gap-1">
                            ...
                            <button
                                ...
                                className="flex items-center justify-between w-full px-2.5 py-1.5 rounded-lg text-left hover:bg-black/5 transition-colors"
                            >
