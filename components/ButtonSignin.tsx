    ...
    <div className="max-w-sm w-full space-y-8">
      ...
      <form onSubmit={handleEmailSignIn} className="space-y-3">
        <input
          ...
          required
          className="w-full h-12 px-4 rounded-xl border border-border bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-colors body"
        />
        <Button
          type="submit"
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="label text-muted-foreground !normal-case">or</span>
        <div className="flex-1 h-px bg-border" />
      </div>
